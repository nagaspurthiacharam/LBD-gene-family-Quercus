...
#        qrlbd_to_rgq29_mapping_NEW.csv (status == "primary"). QrLBDs
...
WORK_DIR  <- "."
COUNTS    <- "gene_count_matrix.csv"             # raw StringTie / prepDE output
MAPPING   <- "qrlbd_to_rgq29_mapping_NEW.csv"    # gene_id <-> QrLBD name
